...
const (
	...
	FFMPEG_ARGS_HLS     string = " -bsf h264_mp4toannexb -f segment -codec copy -map 0 -segment_time 2 -segment_format mpegts -segment_list_flags +live -segment_list_type m3u8 -individual_header_trailer 1 -segment_list index.m3u8 hls/%09d.ts"
